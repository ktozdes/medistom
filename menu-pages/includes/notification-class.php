...
if(!class_exists("Notification")) {
    ...
    {
         //notify admin
         function notifyadmin($On, $AppId, $ServiceId, $StaffId, $ClientId, $BlogName)
         {
             global $TimeFormat;
             global $DateFormat;
             global $wpdb;
         ...
         //notify client
         function notifyclient($Status, $AppId, $ServiceId, $StaffId, $ClientId, $BlogName)
         {
             global $TimeFormat;
             global $DateFormat;
            global $wpdb;
         ...
         //notify staff
         function notifystaff($Status, $AppId, $ServiceId, $StaffId, $ClientId, $BlogName)
         {
