...
require_once("lang/localization.lib.php");
...
if(file_exists("calendar/calendar.js")) {
    ...
    ?><script language="javascript" src="calendar.js"></script><?php
}
if(!class_exists("tc_calendar")) {
    class tc_calendar{
        var $icon;
        var $objname;
        ...
        function writeCalendarContainer(){
            ...
            echo("<div id=\"div_".$this->objname."\" style=\"height:210px; position:".$div_position.";visibility:".$div_display.";z-index:100;".$div_align.";margin-left:".$margin_left."\" class=\"div_calendar calendar-border\" ".$mout_str." ".$mover_str.">");
            echo("<IFRAME id=\"".$this->objname."_frame\" src=\"".$this->path."calendar_form.php".$paramStr."\" frameBorder=\"0\" scrolling=\"no\" allowtransparency=\"true\" width=\"250px\" height=\"100%\" style=\"z-index: 100;\" margin-left=$margin_left></IFRAME>");
            echo("</div>");
        }
