...
if(isset($language)){
    require_once("lang/calendar.".$language.".php");
}
...
function selectDay(d){
    ...
    /*alert(f);
    alert(f.selected_day.value);
    alert(f.selected_month.value);
    alert(f.selected_year.value);*/
          ...
          <div class="btn" style="width:208px;">
            ...
            <div style="margin-left: 30px; margin-right: 30px;font-size:1.9em;border-radius:15px 15px 5px 5px;margin-top:5px;color:white;" align="center">
                ...
                <?php
                    ...
                    $months = array(L_DEC,L_JAN, L_FEB, L_MAR, L_APR, L_MAY, L_JUN, L_JUL, L_AUG, L_SEP, L_OCT, L_NOV);
